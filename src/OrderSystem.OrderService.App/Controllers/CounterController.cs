...
namespace OrderSystem.OrderService.App.Controllers;
...
using OrderSystem.OrderService.App.Actors;
...
public class CounterController : ControllerBase
{
    ...
    [HttpGet("{counterId}")]
    public async Task<OrderSystem.OrderService.App.Actors.Counter> Get(string counterId)
    {
        var counter = await this.counterActor.Ask<OrderSystem.OrderService.App.Actors.Counter>(new FetchCounter(counterId), TimeSpan.FromSeconds(5));
        return counter;
    }
